...
RULE_DESCRIPTIONS = [
    ...
    {"level": "soft", "title": "教师课时均衡", "detail": "教师承担的全部课程按周一至周五合并计算，尽量均匀分布，并避免同一教师连续上课超过2节。"},
    {"level": "soft", "title": "兼课教师末节减压", "detail": "同时承担语数英和其他课程的教师，尽量避开上午第4节、下午第3节；阅读视为语文教学延伸，不计入该项末节避让。"},
