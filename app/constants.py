...
RULE_DESCRIPTIONS = [
    {"level": "hard", "title": "班会固定", "detail": "1—6年级每周一下午第3节安排班队会（安全课）。"},
    {"level": "hard", "title": "低年级阅读", "detail": "1—2年级每周三下午后两节安排阅读连堂。"},
    {"level": "hard", "title": "中高年级阅读", "detail": "3—6年级每周四下午后两节安排阅读连堂。"},
    {"level": "hard", "title": "趣味课堂", "detail": "3—6年级每周三下午前两节安排趣味课堂。"},
    {"level": "hard", "title": "教研避让", "detail": "周一下午前两节不排3—6年级英语；周二下午前两节不排语文；周四下午前两节不排数学。"},
